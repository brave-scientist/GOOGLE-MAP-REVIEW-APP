    ...
    <LegalLayout title="Refund Policy" lastUpdated="August 7, 2026">
      ...
      <section>
        ...
        <ul className="list-disc pl-6 space-y-1 mt-2">
          ...
          <li>To request a refund, email <a href="mailto:billing@reviewreply.com" className="text-[var(--brass)] hover:underline">billing@reviewreply.com</a> within 3 days of the charge.</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="list-disc pl-6 space-y-1 mt-2">
          ...
          <li>To request a refund, email <a href="mailto:billing@reviewreply.com" className="text-[var(--brass)] hover:underline">billing@reviewreply.com</a>.</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          You can cancel your subscription at any time via Settings → Billing → Manage Subscription, or by emailing <a href="mailto:billing@reviewreply.com" className="text-[var(--brass)] hover:underline">billing@reviewreply.com</a>.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="list-none pl-0 mt-2 space-y-1">
          <li><strong>Email:</strong> <a href="mailto:billing@reviewreply.com" className="text-[var(--brass)] hover:underline">billing@reviewreply.com</a></li>
        </ul>
      </section>
    </LegalLayout>
  )

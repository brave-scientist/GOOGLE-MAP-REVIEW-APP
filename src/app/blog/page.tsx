...
const POSTS = [
  {
    ...
    content: [
      ...
      'At ReviewReply, we use the ReviewReply AI Engine with a per-business brand voice profile. The profile is built from your approved past replies and is encrypted at rest. Every draft is generated using this profile as the system prompt, plus few-shot examples from your best replies.',

...
const POSTS = [
  {
    ...
    content: [
      ...
      'At ReviewReply, we use Claude 3.5 Sonnet with a per-business brand voice profile. The profile is built from your last 50–200 approved replies and is encrypted at rest. Every draft is generated using this profile as the system prompt, plus 5-shot examples from your best replies.',

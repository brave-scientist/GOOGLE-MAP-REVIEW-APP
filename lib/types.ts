...
/** Locked plan limits per Product-Roadmap.md Section 0. */
export const PLAN_LIMITS = {
  starter: { monthlyReviewRequests: 100, facebook: false, sms: false },
  pro: { monthlyReviewRequests: 300, facebook: true, sms: true },
} as const;

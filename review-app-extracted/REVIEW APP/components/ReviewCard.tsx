 ...
 *
 * Hydration note: the "Posted {timestamp}" line uses `toLocaleString()`, which
 * formats differently on the server (UTC) vs the client (local TZ). To avoid
 * a hydration mismatch, we only render the formatted timestamp after the
...
export default function ReviewCard({
  ...
  return (
    <div data-review-id={review.id} className="rounded-xl border border-cream/10 bg-ink-2 p-5">
      {/* Review header */}
